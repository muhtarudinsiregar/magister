				...
				<nav class="navbar navbar-default navbar-inverse" role="navigation">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav">
							...
							<li><a href="{{ url('pekerjaan/'.Auth::id().'/edit')}}">Pekerjaan</a></li>
							<li><a href="{{ url('pendanaan/'.Auth::id().'/edit')}}">Pendanaan</a></li>
							<li><a href="{{ url('kontak/'.Auth::id().'/edit')}}">Kontak</a></li>
							<li><a href="{{ url('jadwal/'.Auth::id().'/edit')}}">Jadwal Tes</a></li>
