		...
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="row">
					...
					{{ Form::open(array('method'=>'PUT','class'=>'form-horizontal','url' => 'validasis/'.$data_user->no)) }}
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="form_pendaftaran" {{($validasi->l1 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="bukti" {{($validasi->l2 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="ijazah" {{($validasi->l3 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="transkrip" {{($validasi->l4 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="rekomendasi" {{($validasi->l5 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="foto3" {{($validasi->l6 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="foto4" {{($validasi->l7 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="surat_kesehatan" {{($validasi->l8 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="program_studi" {{($validasi->d1 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="akreditasi" {{($validasi->d2 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="ipk" {{($validasi->d3 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
										...
										<td>
											<div class="checkbox checkbox-custom">
												<label>
													...
													<input type="checkbox" value="1" name="jenjang" {{($validasi->d4 =='1')?'checked="checked"':''}}>
												</label>
											</div>
										</td>
									</tr>
