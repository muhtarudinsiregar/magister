...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/ink.css') }}"> <!-- For testing only -->
                              ...
                              <tr>
                                <td class="wrapper last">
                                  <table class="twelve columns">
                                    <tr>
                                      <td>
                                          <h4>Assalamu&rsquo;alaikum wr. wb.</h4>
                                          <p class="lead">Anda telah mendaftar di Program Pascasarjana Fakultas Teknologi Industri Universitas Islam Indonesia.</p>
                                          <table class="row">
                                            <tr>
                                                <td>Nama</td>
                                                <td>:</td>
                    ...
                    <tr>
                        <td>
                            <table class="row">
                                <tr>
                                    <td class="wrapper last">
                                        <table class="row">
                                            ...
                                            <tr>
                                                <td class="wrapper last">1. Pembayaran biaya pendaftaran</td>
                                            </tr>
                                            <tr>
                                                <td>
                                ...
                                <tr>
                                    <td>2. Penyerahan/pengiriman berkas</td>
                                </tr>
                                <tr class="offset-by-one">
                                    <td>
                                        <ul type="disc">
                                ...
                                <tr>
                                    <td><strong>Berkas diserahkan/dikirimkan kepada : </strong></td>
                                </tr>
                                <tr>
                                    <td></td>
                                </tr>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <br />
                                        <br />
                                        <p><strong>Terimakasih atas perhatian Anda.</strong></p>
